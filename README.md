...
The packaged extension is exercised against tend.host's real schema-2 installer in a disposable fixture, including integrity, scoped-storage, uninstall, and file cleanup. Its browser lifecycle is also mounted and unmounted twice. Repository inspection and bundled-starter creation now use narrow tend.host capabilities with durable evidence. Portable intents for isolated preview and publishing remain non-executing until their own separately reviewed host workers exist.
